                    ...
                    if (cacheItemFileStat) {
                        ...
                        if (cacheItem) {
                            ...
                            if (state.hasValue) {
                                ...
                                yield node_cache_FileController.lockPaths([valueFilePath], () => tslib.__awaiter(this, void 0, void 0, function* () {
                    ...
                    if (!state) {
                        ...
                        if (!filterResult || filterResult.call(_this, state, args)) {
                            ...
                            yield Promise.all([
                                ...
                                valueBuffer && node_cache_FileController.lockPaths([valueFilePath], () => fileController.writeFile(valueFilePath, valueBuffer)),
                            ]);
                        }
                    }
                }
